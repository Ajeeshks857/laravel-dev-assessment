...
const updateJobTitle = (newValue: string) => {
    emit('update:jobTitle', newValue)
}
                ...
                >
                    <div class="flex-1 flex items-center border-r">
                        ...
                        <input
                            ...
                            @input="updateJobTitle($event.target.value)"
                    ...
                    <div class="flex-1 flex items-center">
                        ...
                        <input
                            ...
                            @input="updateLocation($event.target.value)"
